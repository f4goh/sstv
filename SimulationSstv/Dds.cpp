...
uint8_t Dds::simulationInteruption() {
    const static uint8_t sinusTable[512] {128, 129, 131, 132, 134, 135, 137, 138, 140, 141, 143, 145, 146, 148, 149, 151, 152, 154, 155, 157, 158, 160, 161, 163, 164, 166, 167, 169, 170, 172, 173, 175, 176, 178, 179, 180, 182, 183, 185, 186,
    ...
    sinus = sinusTable[phase]; //lecture de la valeur du sinus dans la table 
